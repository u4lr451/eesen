#include "atlas_asm.h"
/*
 * This file does a 2x6 unrolled r1_sse with these params:
 *    CL=8, ORDER=clmajor
 */
 ...
 */
   ...
   LOOPN:
      ...
      LOOPM:
         ...
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         MOVA   64-128(pA0,lda5), ra0
         addps ra0, rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 64-128(pA0,lda5)
         ...
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         MOVA   80-128(pA0,lda5), ra0
         addps ra0, rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 80-128(pA0,lda5)
         ...
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         MOVA   96-128(pA0,lda5), ra0
         addps ra0, rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 96-128(pA0,lda5)
         ...
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         MOVA   112-128(pA0,lda5), ra0
         addps ra0, rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 112-128(pA0,lda5)
