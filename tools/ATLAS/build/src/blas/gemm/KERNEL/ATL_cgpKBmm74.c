...
static void ATL_cJIK0x0x74TN1x1x74_a1_bX
 ...
 * lda=74, ldb=74, ldc=0, mu=1, nu=1, ku=74, pf=1
 ...
 */
{
   ...
   #define incAk 74
   const int incAm = 0, incAn = -(74*(Mb));
   #define incBk 74
   const int incBm = -74, incBn = 74;
   const int incAk0 = ((incAk) / 74), incBk0 = ((incBk) / 74);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=74, 
 * lda=74, ldb=74, ldc=0, mu=6, nu=1, ku=74, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 74
   const int incAm = 370, incAn = -(74*(Mb));
   #define incBk 74
   const int incBm = -74, incBn = 74;
   const int incAk0 = ((incAk) / 74), incBk0 = ((incBk) / 74);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x74TN1x1x74_a1_bX(k, N, 74, alpha, ca + (74*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
