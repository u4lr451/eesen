#ifdef ATL_UCLEANM
#define ATL_dJIK0x56x56TN56x56x0_a1_b0 ATL_dgpMBmm_b0
#else
#define ATL_dJIK0x56x56TN56x56x0_a1_b0 ATL_dpMBmm_b0
#endif
...
#endif
#endif
static void ATL_dJIK0x56x56TN1x2x56_a1_b0
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_dJIK0x56x56TN56x56x0_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=56, KB=56, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_dJIK0x56x56TN1x2x56_a1_b0(k, 56, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
