...
static void ATL_cJIK2x0x80TN2x1x80_a1_b0
...
/*
 * matmul with TA=T, TB=N, MB=2, NB=0, KB=80, 
 * lda=80, ldb=80, ldc=0, mu=2, nu=1, ku=80, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Nb N
   const float *stM = A + 160;
   const float *stN = B + (((Nb) << 6)+((Nb) << 4));
   const float *pfA = stM;
   const int incPFA0 = (((int)(stM - A))*2*1)/(2*N*sizeof(float));
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 80
   const int incAm = 80, incAn = -160;
   #define incBk 80
 ...
 */
   ...
   #undef Kb
#endif
void ATL_cJIK80x0x80TN80x80x0_a1_b0
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
{
   ...
   float *cc=C;
   const float *stM = A + 6240;
   const float *stN = B + (((Nb) << 6)+((Nb) << 4));
   const float *pfA = stM;
   const int incPFA0 = (((int)(stM - A))*6*1)/(80*N*sizeof(float));
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 80
   const int incAm = 400, incAn = -6240;
   #define incBk 80
   const int incBm = -80, incBn = 80;
   const int incAk0 = ((incAk) / 80), incBk0 = ((incBk) / 80);
   #define incCm 12
 ...
 */
   ...
   while(pB0 != stN);
   ATL_cJIK2x0x80TN2x1x80_a1_b0(2, N, 80, alpha, ca + 6240, lda, cb, ldb, beta, cc + 156, ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
void ATL_cJIK80x0x80TN80x80x0_a1_b0(const int M, const int N, const int K, const float alpha, const float *A, const int lda, const float *B, const int ldb, const float beta, float *C, const int ldc);
...
{
   ATL_cJIK80x0x80TN80x80x0_a1_b0(M, N, K, alpha, A, lda, B, ldb, -beta, C, ldc);
   ATL_cJIK80x0x80TN80x80x0_a1_b0(M, N, K, alpha, A, lda, B+N*ldb, ldb, beta, C+1, ldc);
