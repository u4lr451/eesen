...
#endif
#endif
static void ATL_zJIK0x0x36TN1x1x36_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x36TN2x1x36_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x36TN1x1x36_a1_bX(k, N, 36, alpha, ca + (((Mb) << 5)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK0x0x36TN1x4x36_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 * lda=36, ldb=36, ldc=0, mu=1, nu=4, ku=36, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x36TN1x1x36_a1_bX(M, k, 36, alpha, ca, lda, cb + (((Nb) << 5)+((Nb) << 2)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x36TN36x36x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 * lda=36, ldb=36, ldc=0, mu=2, nu=4, ku=36, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x36TN2x1x36_a1_bX(M, k, 36, alpha, ca, lda, cb + (((Nb) << 5)+((Nb) << 2)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x36TN1x4x36_a1_bX(k, Nb, 36, alpha, ca + (((Mb) << 5)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
