...
static void ATL_cJIK0x0x75TN1x1x75_a1_bX
 ...
 * lda=75, ldb=75, ldc=0, mu=1, nu=1, ku=75, pf=1
 ...
 */
{
   ...
   #define incAk 75
   const int incAm = 0, incAn = -(75*(Mb));
   #define incBk 75
   const int incBm = -75, incBn = 75;
   const int incAk0 = ((incAk) / 75), incBk0 = ((incBk) / 75);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=75, 
 * lda=75, ldb=75, ldc=0, mu=6, nu=1, ku=75, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 75
   const int incAm = 375, incAn = -(75*(Mb));
   #define incBk 75
   const int incBm = -75, incBn = 75;
   const int incAk0 = ((incAk) / 75), incBk0 = ((incBk) / 75);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x75TN1x1x75_a1_bX(k, N, 75, alpha, ca + (75*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
