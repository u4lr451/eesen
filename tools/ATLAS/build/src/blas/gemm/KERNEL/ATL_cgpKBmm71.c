 ...
 * lda=71, ldb=71, ldc=0, mu=1, nu=1, ku=71, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 71), incBk0 = ((incBk) / 71);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=71, 
 * lda=71, ldb=71, ldc=0, mu=6, nu=1, ku=71, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 71
   const int incAm = 355, incAn = -(71*(Mb));
   #define incBk 71
   const int incBm = -71, incBn = 71;
   const int incAk0 = ((incAk) / 71), incBk0 = ((incBk) / 71);
   #define incCm 12
