#ifdef ATL_UCLEANN
#define ATL_dJIK56x0x56TN56x56x0_a1_b1 ATL_dgpNBmm_b1
#else
#define ATL_dJIK56x0x56TN56x56x0_a1_b1 ATL_dpNBmm_b1
#endif
...
#endif
#endif
static void ATL_dJIK56x0x56TN4x1x56_a1_b1
 ...
 */
{
   ...
   #define incAk 56
   const int incAm = 168, incAn = -3136;
   #define incBk 56
   ...
   #undef Kb
#endif
void ATL_dJIK56x0x56TN56x56x0_a1_b1
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=56, NB=0, KB=56, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_dJIK56x0x56TN4x1x56_a1_b1(56, k, 56, alpha, ca, lda, cb + (56*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
