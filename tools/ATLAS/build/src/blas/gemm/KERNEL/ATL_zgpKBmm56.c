...
#endif
#endif
static void ATL_zJIK0x0x56TN1x1x56_a1_bX
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 56), incBk0 = ((incBk) / 56);
   #define incCm 2
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x56TN2x1x56_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=56, 
 * lda=56, ldb=56, ldc=0, mu=2, nu=1, ku=56, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (56*(Nb));
   #define incAk 56
   const int incAm = 56, incAn = -(56*(Mb));
   #define incBk 56
   const int incBm = -56, incBn = 56;
   const int incAk0 = ((incAk) / 56), incBk0 = ((incBk) / 56);
   #define incCm 4
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x56TN1x1x56_a1_bX(k, N, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK0x0x56TN1x4x56_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=56, 
 * lda=56, ldb=56, ldc=0, mu=1, nu=4, ku=56, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x56TN1x1x56_a1_bX(M, k, 56, alpha, ca, lda, cb + (56*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x56TN56x56x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=56, 
 * lda=56, ldb=56, ldc=0, mu=2, nu=4, ku=56, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x56TN2x1x56_a1_bX(M, k, 56, alpha, ca, lda, cb + (56*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x56TN1x4x56_a1_bX(k, Nb, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
