...
#endif
#endif
static void ATL_zJIK0x0x52TN1x1x52_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x52TN2x1x52_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 * lda=52, ldb=52, ldc=0, mu=2, nu=1, ku=52, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x52TN1x1x52_a1_bX(k, N, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK0x0x52TN1x4x52_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 * lda=52, ldb=52, ldc=0, mu=1, nu=4, ku=52, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x52TN1x1x52_a1_bX(M, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 * lda=52, ldb=52, ldc=0, mu=2, nu=4, ku=52, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x52TN2x1x52_a1_bX(M, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x52TN1x4x52_a1_bX(k, Nb, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
