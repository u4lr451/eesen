...
#endif
#endif
static void ATL_zJIK0x0x54TN1x1x54_a1_bX
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 54), incBk0 = ((incBk) / 54);
   #define incCm 2
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x54TN2x1x54_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=54, 
 * lda=54, ldb=54, ldc=0, mu=2, nu=1, ku=54, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (54*(Nb));
   #define incAk 54
   const int incAm = 54, incAn = -(54*(Mb));
   #define incBk 54
   const int incBm = -54, incBn = 54;
   const int incAk0 = ((incAk) / 54), incBk0 = ((incBk) / 54);
   #define incCm 4
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x54TN1x1x54_a1_bX(k, N, 54, alpha, ca + (54*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK0x0x54TN1x4x54_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=54, 
 * lda=54, ldb=54, ldc=0, mu=1, nu=4, ku=54, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x54TN1x1x54_a1_bX(M, k, 54, alpha, ca, lda, cb + (54*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x54TN54x54x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=54, 
 * lda=54, ldb=54, ldc=0, mu=2, nu=4, ku=54, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x54TN2x1x54_a1_bX(M, k, 54, alpha, ca, lda, cb + (54*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x54TN1x4x54_a1_bX(k, Nb, 54, alpha, ca + (54*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
