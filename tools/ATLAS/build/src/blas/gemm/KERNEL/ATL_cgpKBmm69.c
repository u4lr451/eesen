 ...
 * lda=69, ldb=69, ldc=0, mu=1, nu=1, ku=69, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 69), incBk0 = ((incBk) / 69);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=69, 
 * lda=69, ldb=69, ldc=0, mu=6, nu=1, ku=69, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 69
   const int incAm = 345, incAn = -(69*(Mb));
   #define incBk 69
   const int incBm = -69, incBn = 69;
   const int incAk0 = ((incAk) / 69), incBk0 = ((incBk) / 69);
   #define incCm 12
