...
#endif
#endif
static void ATL_zJIK0x0x53TN1x1x53_a1_bX
 ...
 */
{
   #define Mb M
   #define Nb N
   const double *stM = A + (53*(Mb));
   const double *stN = B + (53*(Nb));
   #define incAk 53
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x53TN2x1x53_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=53, 
 * lda=53, ldb=53, ldc=0, mu=2, nu=1, ku=53, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (53*(Nb));
   #define incAk 53
   const int incAm = 53, incAn = -(53*(Mb));
   #define incBk 53
   const int incBm = -53, incBn = 53;
   const int incAk0 = ((incAk) / 53), incBk0 = ((incBk) / 53);
   #define incCm 4
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x53TN1x1x53_a1_bX(k, N, 53, alpha, ca + (53*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK0x0x53TN1x4x53_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=53, 
 * lda=53, ldb=53, ldc=0, mu=1, nu=4, ku=53, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x53TN1x1x53_a1_bX(M, k, 53, alpha, ca, lda, cb + (53*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x53TN53x53x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=53, 
 * lda=53, ldb=53, ldc=0, mu=2, nu=4, ku=53, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x53TN2x1x53_a1_bX(M, k, 53, alpha, ca, lda, cb + (53*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x53TN1x4x53_a1_bX(k, Nb, 53, alpha, ca + (53*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
