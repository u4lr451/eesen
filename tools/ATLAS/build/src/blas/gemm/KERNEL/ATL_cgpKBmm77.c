...
static void ATL_cJIK0x0x77TN1x1x77_a1_bX
 ...
 * lda=77, ldb=77, ldc=0, mu=1, nu=1, ku=77, pf=1
 ...
 */
{
   ...
   #define incAk 77
   const int incAm = 0, incAn = -(77*(Mb));
   #define incBk 77
   const int incBm = -77, incBn = 77;
   const int incAk0 = ((incAk) / 77), incBk0 = ((incBk) / 77);
   #define incCm 2
   ...
   register float rA0;
   register float rB0;
   register float m0, m1, m2, m3, m4, m5, m6;
 ...
 */
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x77TN77x77x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=77, 
 * lda=77, ldb=77, ldc=0, mu=6, nu=1, ku=77, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 77
   const int incAm = 385, incAn = -(77*(Mb));
   #define incBk 77
   const int incBm = -77, incBn = 77;
   const int incAk0 = ((incAk) / 77), incBk0 = ((incBk) / 77);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x77TN1x1x77_a1_bX(k, N, 77, alpha, ca + (77*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
