 ...
 * lda=65, ldb=65, ldc=0, mu=1, nu=1, ku=65, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 65), incBk0 = ((incBk) / 65);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=65, 
 * lda=65, ldb=65, ldc=0, mu=6, nu=1, ku=65, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 65
   const int incAm = 325, incAn = -(((Mb) << 6)+Mb);
   #define incBk 65
   const int incBm = -65, incBn = 65;
   const int incAk0 = ((incAk) / 65), incBk0 = ((incBk) / 65);
   #define incCm 12
