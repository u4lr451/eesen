...
static void ATL_cJIK0x0x79TN1x1x79_a1_bX
 ...
 * lda=79, ldb=79, ldc=0, mu=1, nu=1, ku=79, pf=1
 ...
 */
{
   ...
   #define incAk 79
   const int incAm = 0, incAn = -(79*(Mb));
   #define incBk 79
   const int incBm = -79, incBn = 79;
   const int incAk0 = ((incAk) / 79), incBk0 = ((incBk) / 79);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=79, 
 * lda=79, ldb=79, ldc=0, mu=6, nu=1, ku=79, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 79
   const int incAm = 395, incAn = -(79*(Mb));
   #define incBk 79
   const int incBm = -79, incBn = 79;
   const int incAk0 = ((incAk) / 79), incBk0 = ((incBk) / 79);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x79TN1x1x79_a1_bX(k, N, 79, alpha, ca + (79*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
