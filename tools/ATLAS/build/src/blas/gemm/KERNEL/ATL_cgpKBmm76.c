...
static void ATL_cJIK0x0x76TN1x1x76_a1_bX
 ...
 * lda=76, ldb=76, ldc=0, mu=1, nu=1, ku=76, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 76), incBk0 = ((incBk) / 76);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=76, 
 * lda=76, ldb=76, ldc=0, mu=6, nu=1, ku=76, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 76
   const int incAm = 380, incAn = -(76*(Mb));
   #define incBk 76
   const int incBm = -76, incBn = 76;
   const int incAk0 = ((incAk) / 76), incBk0 = ((incBk) / 76);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x76TN1x1x76_a1_bX(k, N, 76, alpha, ca + (76*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
