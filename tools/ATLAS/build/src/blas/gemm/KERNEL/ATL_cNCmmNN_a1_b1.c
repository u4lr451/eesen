...
#endif
#endif
static void ATL_cJIK4x52x52NN4x1x52_a1_b1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_cJIK52x52x52NN0x0x0_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   while(pB0 != stN);
   ATL_cJIK4x52x52NN4x1x52_a1_b1(4, 52, 52, alpha, ca + 96, lda, cb, ldb, beta, cc + 96, ldc);
}
#ifdef incAm
   #undef incAm
#endif
