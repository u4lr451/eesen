...
static void ATL_cJIK0x0x78TN1x1x78_a1_bX
 ...
 * lda=78, ldb=78, ldc=0, mu=1, nu=1, ku=78, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 78), incBk0 = ((incBk) / 78);
   #define incCm 2
 ...
 */
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x78TN78x78x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=78, 
 * lda=78, ldb=78, ldc=0, mu=6, nu=1, ku=78, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 78
   const int incAm = 390, incAn = -(78*(Mb));
   #define incBk 78
   const int incBm = -78, incBn = 78;
   const int incAk0 = ((incAk) / 78), incBk0 = ((incBk) / 78);
   #define incCm 12
 ...
 */
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x78TN1x1x78_a1_bX(k, N, 78, alpha, ca + (78*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
