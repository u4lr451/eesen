 ...
 * lda=66, ldb=66, ldc=0, mu=1, nu=1, ku=66, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 66), incBk0 = ((incBk) / 66);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=66, 
 * lda=66, ldb=66, ldc=0, mu=6, nu=1, ku=66, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 66
   const int incAm = 330, incAn = -(((Mb) << 6)+((Mb) << 1));
   #define incBk 66
   const int incBm = -66, incBn = 66;
   const int incAk0 = ((incAk) / 66), incBk0 = ((incBk) / 66);
   #define incCm 12
