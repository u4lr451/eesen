 ...
 * lda=67, ldb=67, ldc=0, mu=1, nu=1, ku=67, pf=1
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 67), incBk0 = ((incBk) / 67);
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=67, 
 * lda=67, ldb=67, ldc=0, mu=6, nu=1, ku=67, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M/6)*6;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 67
   const int incAm = 335, incAn = -(67*(Mb));
   #define incBk 67
   const int incBm = -67, incBn = 67;
   const int incAk0 = ((incAk) / 67), incBk0 = ((incBk) / 67);
   #define incCm 12
