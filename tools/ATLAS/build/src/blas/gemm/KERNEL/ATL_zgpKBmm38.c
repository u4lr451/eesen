 ...
 */
   ...
   #undef Kb
#endif
static void ATL_zJIK0x0x38TN2x1x38_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=38, 
...
#endif
#endif
static void ATL_zJIK0x0x38TN1x4x38_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=38, 
 * lda=38, ldb=38, ldc=0, mu=1, nu=4, ku=38, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x38TN1x1x38_a1_bX(M, k, 38, alpha, ca, lda, cb + (38*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=38, 
 * lda=38, ldb=38, ldc=0, mu=2, nu=4, ku=38, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.0)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_zJIK0x0x38TN2x1x38_a1_bX(M, k, 38, alpha, ca, lda, cb + (38*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_zJIK0x0x38TN1x4x38_a1_bX(k, Nb, 38, alpha, ca + (38*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
