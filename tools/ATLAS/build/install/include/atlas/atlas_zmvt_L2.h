...
void ATL_zmvtk__900007(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
void ATL_zmvtk__900007_b0(ATL_CINT, ATL_CINT, const double*, ATL_CINT, const double*, double*);
    ...
    int *alignY, int *FNU, ATL_INT *CacheElts) 
{
   ...
   *FNU = 1;
   *CacheElts = 3072;
   *mvk_b0 = ATL_zmvtk__900007_b0;
   return(ATL_zmvtk__900007);
}

#define ATL_GetPartMVT(A_, lda_, mb_, nb_) { *(mb_) = 508; *(nb_) = 2; }
